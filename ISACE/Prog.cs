...
namespace ISACE
{
    class Prog
    {
        ...
        public void FillProgInfo(string query)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                ...
                Program.f1.guna2DataGridView3.DataSource = Prog_set.Tables[0];
                Program.f1.guna2DataGridView3.Columns[0].Visible = false;
        ...
        public void ProgQuery(string query)
        {
