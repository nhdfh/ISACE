...
namespace ISACE
{
    public partial class MainForm : System.Windows.Forms.Form
    {
        ...
        private void guna2Button6_Click(object sender, EventArgs e)//изменить пользователя
        {
            ...
            UserRedactorForm f = new UserRedactorForm();
        ...
        {
            Program.flag = true;
            TechReportForm f = new TechReportForm();
            if (Program.nool == true)
            {
                f.ShowDialog();
            }
        ...
        {
            Program.flag = true;
            RecomendationForm f = new RecomendationForm();
            if (Program.nool == true)
            {
                f.ShowDialog();
            }
        ...
        {
            Program.flag = true;
            TypeTestForm f = new TypeTestForm();
        ...
        {
            Program.flag = true;
            TypeComponentForm f = new TypeComponentForm();
        ...
        {
            Program.flag = true;
            TypeReportForm f = new TypeReportForm();
        ...
        {
            Program.flag = true;
            TypeEquipmentForm f = new TypeEquipmentForm();
