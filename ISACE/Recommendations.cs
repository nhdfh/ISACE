...
namespace ISACE
{
    class Recommendations
    {
        ...
        public void FillRecInfo(string query)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                ...
                DataSet Recommend_set = new DataSet();
                adapter.Fill(Recommend_set);
                Program.f1.guna2DataGridView7.DataSource = Recommend_set.Tables[0];
                //guna2DataGridView4.DataSource = user_set.Tables[0];
                Program.f1.guna2DataGridView7.Columns[0].Visible = false;
        ...
        public void RecQuery(string query)
        {
