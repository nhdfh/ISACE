...
namespace ISACE
{
    class Breackdowns
    {
        ...
        public void FillBreackdownsInfo(string query)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                ...
                DataSet Breackdowns_set = new DataSet();
                adapter.Fill(Breackdowns_set);
                Program.f1.guna2DataGridView5.DataSource = Breackdowns_set.Tables[0];
                //guna2DataGridView4.DataSource = user_set.Tables[0];
                Program.f1.guna2DataGridView5.Columns[0].Visible = false;
        ...
        public void BreackdownQuery(string query)
        {
